...
export class StudentAuthService {
  ...
  static async registration(
    ...
    email: string,
    password: string
  ): Promise<AxiosResponse<StudentAuthReponse>> {
    return $api.post<StudentAuthReponse>(
      `${this.controllerPrefix}/registration`,
  ...
  static async login(
    ...
    return await axios.post<StudentAuthReponse>(
      `${API_URL}/${this.controllerPrefix}/login`,
      { email, password },
  ...
  static async refreshState(): Promise<AxiosResponse<StudentAuthReponse>> {
    return axios.get<StudentAuthReponse>(
      `${API_URL}/${this.controllerPrefix}/refresh`,
      { withCredentials: true }
    );
  }
}
...
export class CompanyAuthService {
  ...
  static async registration(
    ...
    phone: string
  ): Promise<AxiosResponse<CompanyAuthReponse>> {
    return $api.post<CompanyAuthReponse>(
      `${this.controllerPrefix}/registration`,
  ...
  static async login(
    ...
    return await axios.post<CompanyAuthReponse>(
      `${API_URL}/${this.controllerPrefix}/login`,
      { email, password },
      { withCredentials: true }
    );
  ...
  static async refreshState(): Promise<AxiosResponse<CompanyAuthReponse>> {
    return axios.get<CompanyAuthReponse>(
      `${API_URL}/${this.controllerPrefix}/refresh`,
      { withCredentials: true }
    );
  }
