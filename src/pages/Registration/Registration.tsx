...
import { userFormTextRegistration, companyFormTextRegistration } from "./config/formTextConfig";
...
const Registration = () => {
  ...
  const formUserTextConfig: TFormUserTextConfigRegistration[] = userFormTextRegistration(registerUser, userErrors)
  const formCompanyTextConfig: TFormCompanyTextConfigRegistration[] = companyFormTextRegistration(registerCompany, companyErrors)
  ...
  const onCompanySubmit = handleCompanySubmit(async (data: TFormCompanyRegistration) => {
    try {
          ...
          <>
            {
              ...
              ?
                <RegistrationForm isUserExists={isUserExists} formTextConfig={formUserTextConfig} onSubmit={onUserSubmit} />
              :
                <RegistrationForm isUserExists={isUserExists} formTextConfig={formCompanyTextConfig} onSubmit={onCompanySubmit} />
            }
          </>
        :
